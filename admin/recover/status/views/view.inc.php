<script>
    ...
    function recover(){
        var checkbox = document.getElementsByName("summit_status_id[]");
        var data = []; 
...
<div class="col-lg-12"> 
    <table>
        ...
        <tbody>
            ...
            ?>
                <tr class="nth-child">
                    <td><input type="checkbox" name="summit_status_id[]" value="<?php echo $status[$i]['debt_schedule_status_id'];?>" /></td>
                    <td><?php echo $status[$i]['debt_schedule_status_name'];?></td> 
                </tr>
            <?php 
            } 
            ?>
