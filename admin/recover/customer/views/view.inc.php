<script>
    ...
    function recover(){
        var checkbox = document.getElementsByName("summit_customer_id[]");
        var data = []; 
        if (confirm("คุณต้องการกู้คืนข้อมูล ?") == true) {
            ...
            $.post( "recover/customer/views/index.inc.php", { 
                customer_id:JSON.stringify(data),
                action:'recover'
            }) 
                    .done(function( data ) { 
                        console.log(data);
...
<div class="col-lg-12"> 
    <table>
        ...
        <tbody>
            ...
            ?>
                <tr class="nth-child">
                    <td><input type="checkbox" name="summit_customer_id[]" value="<?php echo $customer[$i]['customer_id'];?>" /></td>
