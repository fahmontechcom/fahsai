                ...
                <div class="navbar-collapse collapse justify-content-center" id="collapsingNavbar">
                    <ul class="navbar-nav ml-auto mr-auto">
                        ...
                        <li class="nav-item nav-item-style" >
                            <a href="?content=customer"   <?php if($page=="customer"){echo "class='button-head button-head-menu-active'";} else {echo "class='button-head button-head-menu'";}?> ><i class="fa fa-user header-i-size " ></i>
                            <span >ลูกค้า</span></a>
                        </li>
                        <li class="nav-item nav-item-style" >
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle text-center" id="navDropDownLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><i class="fa fa-bell" style="font-size:18px;color:#337ab7;"></i>
                            </a>
                            <div class="dropdown-menu  dropdown-menu-right" aria-labelledby="navDropDownLink">
                                ...
                                <a class="dropdown-item  text-center" href="../logout.php" style="color:black;font-size: 12px;">Show All</a>
                            </div>
                        </li>
                    </ul>
                    <ul class="navbar-nav ">
